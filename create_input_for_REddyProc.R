...
# generate sequences of time in REddyProc format (variable "Hour") for one day and for 
# both hourly and half hourly L2 data
...
# the variable Hour in REddyProc format takes as reference time the final time of the 30 min or 1 h L2 time step
